"""Slash command definitions and autocomplete for the DeepAgent CLI.
...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("rollback", "List or restore filesystem checkpoints", "Session",
               args_hint="[number]"),
    CommandDef("snapshot", "Create or restore state snapshots of DeepAgent config/state", "Session",
    ...
    CommandDef("update", "Update DeepSeek Agent to the latest version", "Info",
               gateway_only=True),
