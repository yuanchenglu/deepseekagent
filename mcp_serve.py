...
def _get_sessions_dir() -> Path:
    ...
    try:
        ...
        return Path(os.environ.get("DEEPAGENT_HOME") or os.environ.get("HERMES_HOME", Path.home() / ".deepagent")) / "sessions"
...
def _load_channel_directory() -> dict:
    ...
    try:
        ...
        directory_file = Path(
            os.environ.get("DEEPAGENT_HOME") or os.environ.get("HERMES_HOME", Path.home() / ".deepagent")
...
class EventBridge:
    ...
    def _poll_once(self, db):
        ...
        try:
            ...
            db_file = Path(os.environ.get("DEEPAGENT_HOME") or os.environ.get("HERMES_HOME", Path.home() / ".deepagent")) / "state.db"
