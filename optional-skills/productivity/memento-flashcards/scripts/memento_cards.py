...
_DEEPAGENT_HOME = Path(os.environ.get("DEEPAGENT_HOME") or os.environ.get("HERMES_HOME", Path.home() / ".deepagent"))
DATA_DIR = _DEEPAGENT_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
