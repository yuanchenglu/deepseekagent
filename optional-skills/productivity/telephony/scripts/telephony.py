...
def _deepagent_home() -> Path:
    return Path(os.environ.get("DEEPAGENT_HOME") or os.environ.get("HERMES_HOME", "~/.deepagent")).expanduser()


def _env_path() -> Path:
    return _deepagent_home() / ".env"


def _config_path() -> Path:
    return _deepagent_home() / "config.yaml"


def _state_path() -> Path:
    return _deepagent_home() / "telephony_state.json"
