...
Built for [Hermes Agent](https://github.com/yuanchenglu/DeepAgent). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/hermes-agent/skills/creative/ascii-video`](https://github.com/yuanchenglu/DeepAgent/tree/main/skills/creative/ascii-video) via PR.
