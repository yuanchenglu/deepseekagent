...
Built for [Hermes Agent](https://github.com/yuanchenglu/deepseekagent). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/hermes-agent/skills/creative/ascii-video`](https://github.com/yuanchenglu/deepseekagent/tree/main/skills/creative/ascii-video) via PR.
