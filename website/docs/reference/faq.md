...
```bash
curl -fsSL https://raw.githubusercontent.com/yuanchenglu/deepseekagent/main/scripts/install.sh | bash
```
...
1. **Search existing issues:** [GitHub Issues](https://github.com/yuanchenglu/deepseekagent/issues)
