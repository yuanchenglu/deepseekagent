export default {
  ...
  runtimeVersions: {
    ...
    deleteRuntimeConfirm: '¿Eliminar DeepAgent Runtime {version}?',
    ...
    activateSuccess: 'Selección de versión guardada. Reinicia DeepAgent para usarla.',
    jobStatus: {
      queued: 'En cola',
  ...
  chat: {
    ...
    contextEditHint: 'Valores comunes: 256k (DeepAgent predeterminado), 128k (GPT-4), 32k (GPT-3.5)',
    ...
    emptyState: 'Inicia una conversacion con DeepAgent Runtime',
    ...
    hermesHistory: 'Historial de DeepAgent',
    historyScopeHint: 'Sesiones del historial de DeepAgent del perfil actual, de solo lectura y agrupadas por origen.',
    ...
    searchScope: 'Alcance de búsqueda: solo base de datos local de sesiones de Web UI; no incluye sesiones históricas DeepAgent de solo lectura.',
...
jobTriggered: 'Job ejecutado',
  ...
  skills: {
    ...
    writeApprovalDescription: 'Aprueba o rechaza escrituras de memoria y skills preparadas por DeepAgent Runtime.',
    writeApprovalRefresh: 'Actualizar',
    writeApprovalEmpty: 'No hay escrituras pendientes.',
    writeApprovalUnsupported: 'Esta version de DeepAgent Runtime no admite revision de escrituras. Actualiza DeepAgent Runtime para usar esta funcion.',
  ...
  plugins: {
    title: 'Plugins',
    refresh: 'Actualizar',
    notice: 'Inventario de solo lectura de manifests de plugins DeepAgent detectables. Los metadatos de descubrimiento se leen sin cargar código de plugins. En v1, la gestión permanece en CLI; los cambios se aplican en nuevas sesiones DeepAgent.',
  ...
  models: {
    ...
    copilotAddDetected: 'Se detectó un token OAuth de GitHub Copilot en este equipo. Haz clic en Agregar para habilitar Copilot en DeepAgent.',
    copilotAddSourceEnv: 'Origen: ~/.deepagent/config/.env (COPILOT_GITHUB_TOKEN)',
    copilotAddSourceGhCli: 'Origen: gh CLI (gh auth token)',
    copilotAddSourceAppsJson: 'Origen: extensión Copilot de VS Code (apps.json)',
    copilotDeleteHintEnv: 'Esto borrará COPILOT_GITHUB_TOKEN en ~/.deepagent/config/.env. Otras herramientas no se verán afectadas.',
    copilotDeleteHintGhCli: 'Copilot se ocultará de DeepAgent. Tu sesión de gh CLI no se verá afectada — `gh auth status` seguirá mostrando que estás conectado.',
    copilotDeleteHintAppsJson: 'Copilot se ocultará de DeepAgent. La extensión Copilot de VS Code seguirá conectada.',
    ...
    visibilityHint: 'Solo afecta al selector de modelos y a la página de modelos de Web UI. No modifica la configuración provider/model de DeepAgent CLI; las llamadas siguen usando el ID original del modelo.',
    ...
    aliasHint: 'Solo cambia el nombre visible en Web UI. DeepAgent sigue recibiendo el ID original del modelo.',
    aliasEdit: 'Renombrar',
  ...
  profiles: {
    ...
    rename: 'Renombrar',
    delete: 'Eliminar',
    switchTo: 'Cambiar DeepAgent Profile',
    switchConfirm: 'Esto ejecutara `hermes profile use {name}` y cambiara el active profile de DeepAgent CLI. Continuar?',
    switchSuccess: 'DeepAgent active profile cambiado a "{name}"',
    switchFailed: 'Error al cambiar DeepAgent Profile. Es posible que la pasarela necesite un reinicio manual.',
  ...
  settings: {
    ...
    gatewayAutoStart: {
      ...
      description: 'Controla qué gateways de perfiles DeepAgent locales inicia la Web UI al arrancar. Se guarda en la configuración de la Web UI, no en el config.yaml del perfil.',
      ...
      managementHint: 'Requiere DeepAgent Runtime 0.17.0 o posterior. Al activarlo, Web UI escribe multiplex_profiles para que el gateway default sirva todos los perfiles; otros perfiles no pueden configurar entradas de mensajeria separadas como Feishu, Weixin o QQBot. Al desactivarlo elimina esa configuración.',
    ...
    session: {
      ...
      memoryWriteApprovalHint: 'Preparar las escrituras de memoria de DeepAgent Runtime para aprobacion antes de guardarlas.',
      skillsWriteApproval: 'Revisar escrituras de skills',
      skillsWriteApprovalHint: 'Preparar los cambios de skills de DeepAgent Runtime para aprobacion antes de guardarlos.',
      writeApprovalTitle: 'Escrituras pendientes de revision',
      writeApprovalDescription: 'Aprueba o rechaza escrituras de memoria y skills preparadas por DeepAgent Runtime.',
      writeApprovalRefresh: 'Actualizar',
      writeApprovalEmpty: 'No hay escrituras pendientes.',
  ...
  codingAgents: {
    ...
    codexDescription: "CLI de OpenAI y flujo del proveedor openai-codex de DeepAgent para tareas de repositorio.",
    copyCommand: "Copiar",
    commandCopied: "Comando copiado",
    ...
    installFailedDeepAgentHint: "La instalación falló. Pide a DeepAgent que lo instale por ti.",
    ...
    notes: {
      ...
      codexAuth: "Agrega credenciales OAuth de OpenAI Codex gestionadas por DeepAgent.",
  ...
  skillsUsage: {
    ...
    subtitle: 'Sigue las cargas y ediciones de habilidades en sesiones de DeepAgent',
    refresh: 'Actualizar',
  ...
  changelog: {
    ...
    new_0_6_22_5: 'El chat de DeepAgent anade el comando /learn, Agent Bridge usa el workspace seleccionado como cwd, y solo las funciones de escritorio para /learn y MoA esperan la proxima version de DeepAgent Runtime',
    ...
    new_0_6_21_7: 'Los headers de chat, group chat y workflow estan mejor alineados; Xiao Fang He muestra sold out; el alcance BSL queda mas claro; se documento el plan /learn; se elimino el proxy DeepAgent obsoleto',
    ...
    new_0_6_18_2: 'DeepAgent MCP se divide en toolsets api, devices y use, con nuevas acciones de sesion, modelos, chat-run y ops',
    ...
    new_0_6_18_6: 'La configuracion de desktop y runtime es mas segura con registro Unicode-safe del PATH en Windows, soporte para publicar runtime DeepAgent Runtime 0.17.0, metadata PWA movil y varias correcciones de recuperacion de profile/auth',
    ...
    new_0_6_13_5: 'Las actualizaciones de escritorio son mas fiables: las actualizaciones de Windows cierran procesos DeepAgent residuales, revisan Cloudflare primero y mantienen GitHub como feed de respaldo',
