export default {
  ...
  runtimeVersions: {
    ...
    deleteRuntimeConfirm: 'Supprimer DeepAgent Runtime {version} ?',
    ...
    activateSuccess: 'Sélection de version enregistrée. Redémarrez DeepAgent pour l’utiliser.',
    jobStatus: {
      queued: 'En attente',
      running: 'En cours',
      completed: 'Terminé',
  ...
  chat: {
    ...
    contextEditHint: 'Valeurs courantes : 256k (DeepAgent par défaut), 128k (GPT-4), 32k (GPT-3.5)',
    ...
    emptyState: 'Demarrer une conversation avec DeepAgent Runtime',
    ...
    hermesHistory: 'Historique DeepAgent',
    historyScopeHint: 'Sessions d’historique DeepAgent du profil actuel en lecture seule, regroupées par source.',
    ...
    searchScope: 'Portée de recherche : base locale des sessions Web UI uniquement ; les sessions d’historique DeepAgent en lecture seule ne sont pas incluses.',
...
jobTriggered: 'Job declenche',
  ...
  skills: {
    ...
    writeApprovalDescription: 'Approuvez ou refusez les ecritures de memoire et de skills preparees par DeepAgent Runtime.',
    writeApprovalRefresh: 'Actualiser',
    writeApprovalEmpty: 'Aucune ecriture en attente.',
    writeApprovalUnsupported: 'Cette version de DeepAgent Runtime ne prend pas en charge la validation des ecritures. Mettez DeepAgent Runtime a jour pour utiliser cette fonction.',
  ...
  plugins: {
    title: 'Plugins',
    refresh: 'Actualiser',
    notice: 'Inventaire en lecture seule des manifests de plugins DeepAgent détectables. Les métadonnées de découverte sont lues sans charger le code des plugins. En v1, la gestion reste dans le CLI; les changements prennent effet dans les nouvelles sessions DeepAgent.',
  ...
  models: {
    ...
    copilotAddDetected: 'Un token OAuth GitHub Copilot a été détecté sur cette machine. Cliquez sur Ajouter pour activer Copilot dans DeepAgent.',
    ...
    copilotDeleteHintEnv: 'Cela supprimera COPILOT_GITHUB_TOKEN dans ~/.deepagent/config/.env. Les autres outils ne sont pas affectés.',
    copilotDeleteHintGhCli: 'Copilot sera masqué dans DeepAgent. Votre connexion gh CLI n\'est pas affectée — `gh auth status` indiquera toujours que vous êtes connecté.',
    copilotDeleteHintAppsJson: 'Copilot sera masqué dans DeepAgent. Votre extension Copilot de VS Code reste connectée.',
    ...
    visibilityHint: 'Affecte uniquement le sélecteur de modèles et la page Modèles de la Web UI. La configuration provider/model de DeepAgent CLI n’est pas modifiée ; les appels utilisent toujours l’ID de modèle d’origine.',
    ...
    aliasHint: 'Modifie uniquement le nom affiché dans la Web UI. DeepAgent reçoit toujours l’ID de modèle d’origine.',
    aliasEdit: 'Renommer',
  ...
  profiles: {
    ...
    rename: 'Renommer',
    delete: 'Supprimer',
    switchTo: 'Changer DeepAgent Profile',
    switchConfirm: 'Cette action execute `hermes profile use {name}` et change le active profile DeepAgent CLI. Continuer ?',
    switchSuccess: 'DeepAgent active profile change vers "{name}"',
    switchFailed: 'Echec du changement DeepAgent Profile. La passerelle peut necessiter un redemarrage manuel.',
  ...
  settings: {
    ...
    gatewayAutoStart: {
      ...
      description: 'Contrôle les gateways de profils DeepAgent locaux que la Web UI démarre au lancement. Cette option est stockée dans la configuration Web UI, pas dans le config.yaml du profil.',
    ...
    session: {
      ...
      memoryWriteApprovalHint: 'Mettre les ecritures de memoire de DeepAgent Runtime en attente de validation avant de les enregistrer.',
      skillsWriteApproval: 'Verifier les ecritures de skills',
      skillsWriteApprovalHint: 'Mettre les modifications de skills de DeepAgent Runtime en attente de validation avant de les enregistrer.',
      writeApprovalTitle: 'Ecritures en attente de validation',
      writeApprovalDescription: 'Approuvez ou refusez les ecritures de memoire et de skills preparees par DeepAgent Runtime.',
      writeApprovalRefresh: 'Actualiser',
      writeApprovalEmpty: 'Aucune ecriture en attente.',
  ...
  codingAgents: {
    ...
    codexDescription: "CLI OpenAI et flux fournisseur DeepAgent openai-codex pour les tâches de dépôt.",
    copyCommand: "Copier",
    commandCopied: "Commande copiée",
    ...
    installFailedDeepAgentHint: "L’installation a échoué. Demandez à DeepAgent de l’installer pour vous.",
    ...
    notes: {
      ...
      codexAuth: "Ajoute les identifiants OAuth OpenAI Codex gérés par DeepAgent.",
  ...
  skillsUsage: {
    ...
    subtitle: 'Suivre les chargements et modifications de compétences dans les sessions DeepAgent',
    refresh: 'Actualiser',
  ...
  changelog: {
    ...
    new_0_6_22_5: 'Le chat DeepAgent ajoute la commande /learn, Agent Bridge utilise le workspace selectionne comme cwd, et seules les commandes desktop /learn et MoA attendent la prochaine version de DeepAgent Runtime',
    ...
    new_0_6_21_7: 'Les headers chat, group chat et workflow sont mieux alignes; Xiao Fang He affiche sold out; le scope BSL est clarifie; le plan /learn est documente; le vieux proxy DeepAgent est supprime',
    ...
    new_0_6_18_2: 'DeepAgent MCP est separe en toolsets api, devices et use, avec de nouvelles actions session, model, chat-run et ops',
    ...
    new_0_6_18_6: 'La configuration desktop et runtime est plus sure avec un enregistrement PATH Windows compatible Unicode, le support de publication runtime DeepAgent Runtime 0.17.0, les metadonnees PWA mobile et plusieurs corrections profile/auth',
    ...
    new_0_6_13_5: 'Les mises a jour desktop sont plus fiables : les mises a niveau Windows ferment les anciens processus DeepAgent, Cloudflare est verifie en premier et GitHub reste le flux de secours',
