...
const translations: Record<DesktopLocale, Record<TranslationKey, string>> = {
  en: {
    'tray.show': 'Show DeepAgent',
    'tray.hide': 'Hide DeepAgent',
    'tray.checkForUpdates': 'Check for Updates',
    'tray.openAtLogin': 'Open at Login',
    'tray.quit': 'Quit DeepAgent',
    'update.upToDateTitle': 'DeepAgent',
    'update.upToDateMessage': 'DeepAgent is up to date.',
    'update.checkingTitle': 'DeepAgent',
    ...
    'update.availableMessage': 'DeepAgent {version} is available.',
    'update.downloading': 'The update is downloading in the background.',
    'update.readyTitle': 'Update ready',
    'update.readyMessage': 'DeepAgent {version} is ready to install.',
    ...
    'update.failedMessage': 'Could not check for DeepAgent updates.',
    ...
    'desktop.downloadCloudflareDetail': 'Use the DeepAgent download proxy.',
  ...
  zh: {
    ...
    'desktop.downloadCloudflareDetail': '使用 DeepAgent 下载代理。',
  ...
  'zh-TW': {
    'tray.show': '顯示 DeepAgent',
    'tray.hide': '隱藏 DeepAgent',
    'tray.checkForUpdates': '檢查更新',
    'tray.openAtLogin': '開機啟動',
    'tray.quit': '結束 DeepAgent',
    'update.upToDateTitle': 'DeepAgent',
    'update.upToDateMessage': 'DeepAgent 已是最新版本。',
    'update.checkingTitle': 'DeepAgent',
    ...
    'desktop.downloadCloudflareDetail': '使用 DeepAgent 下載代理。',
  ...
  ja: {
    ...
    'desktop.downloadCloudflareDetail': 'DeepAgent のダウンロードプロキシを使用します。',
  ...
  ko: {
    ...
    'update.failedMessage': 'DeepAgent 업데이트를 확인할 수 없습니다.',
    ...
    'desktop.downloadCloudflareDetail': 'DeepAgent 다운로드 프록시를 사용합니다.',
  ...
  fr: {
    'tray.show': 'Afficher DeepAgent',
    'tray.hide': 'Masquer DeepAgent',
    'tray.checkForUpdates': 'Rechercher les mises a jour',
    'tray.openAtLogin': 'Ouvrir a la connexion',
    'tray.quit': 'Quitter DeepAgent',
    'update.upToDateTitle': 'DeepAgent',
    'update.upToDateMessage': 'DeepAgent est a jour.',
    'update.checkingTitle': 'DeepAgent',
    ...
    'update.availableMessage': 'DeepAgent {version} est disponible.',
    'update.downloading': 'La mise a jour se telecharge en arriere-plan.',
    'update.readyTitle': 'Mise a jour prete',
    'update.readyMessage': 'DeepAgent {version} est pret a etre installe.',
    ...
    'update.failedMessage': 'Impossible de rechercher les mises a jour de DeepAgent.',
    ...
    'desktop.downloadCloudflareDetail': 'Utilise le proxy de telechargement DeepAgent.',
  ...
  es: {
    'tray.show': 'Mostrar DeepAgent',
    'tray.hide': 'Ocultar DeepAgent',
    'tray.checkForUpdates': 'Buscar actualizaciones',
    'tray.openAtLogin': 'Abrir al iniciar sesion',
    'tray.quit': 'Salir de DeepAgent',
    'update.upToDateTitle': 'DeepAgent',
    'update.upToDateMessage': 'DeepAgent esta actualizado.',
    'update.checkingTitle': 'DeepAgent',
    ...
    'update.availableMessage': 'DeepAgent {version} esta disponible.',
    'update.downloading': 'La actualizacion se esta descargando en segundo plano.',
    'update.readyTitle': 'Actualizacion lista',
    'update.readyMessage': 'DeepAgent {version} esta listo para instalarse.',
    ...
    'update.failedMessage': 'No se pudieron buscar actualizaciones de DeepAgent.',
    ...
    'desktop.downloadCloudflareDetail': 'Usa el proxy de descarga de DeepAgent.',
  ...
  de: {
    'tray.show': 'DeepAgent anzeigen',
    'tray.hide': 'DeepAgent ausblenden',
    'tray.checkForUpdates': 'Nach Updates suchen',
    'tray.openAtLogin': 'Beim Anmelden offnen',
    'tray.quit': 'DeepAgent beenden',
    'update.upToDateTitle': 'DeepAgent',
    'update.upToDateMessage': 'DeepAgent ist auf dem neuesten Stand.',
    'update.checkingTitle': 'DeepAgent',
    ...
    'update.availableMessage': 'DeepAgent {version} ist verfugbar.',
    'update.downloading': 'Das Update wird im Hintergrund heruntergeladen.',
    'update.readyTitle': 'Update bereit',
    'update.readyMessage': 'DeepAgent {version} ist zur Installation bereit.',
    ...
    'update.failedMessage': 'Updates fur DeepAgent konnten nicht gepruft werden.',
    ...
    'desktop.downloadCloudflareDetail': 'Verwendet den DeepAgent Download-Proxy.',
  ...
  pt: {
    ...
    'tray.quit': 'Sair do DeepAgent',
    'update.upToDateTitle': 'DeepAgent',
    'update.upToDateMessage': 'DeepAgent esta atualizado.',
    'update.checkingTitle': 'DeepAgent',
    ...
    'update.availableMessage': 'DeepAgent {version} esta disponivel.',
    'update.downloading': 'A atualizacao esta sendo baixada em segundo plano.',
    'update.readyTitle': 'Atualizacao pronta',
    'update.readyMessage': 'DeepAgent {version} esta pronto para instalar.',
    ...
    'update.failedMessage': 'Nao foi possivel verificar atualizacoes do DeepAgent.',
    ...
    'desktop.downloadCloudflareDetail': 'Usa o proxy de download do DeepAgent.',
